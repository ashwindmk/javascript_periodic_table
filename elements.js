...
var elements = [
    ...
    },
    {
      ...
      atomic_mass: 320,
      boil: 1700,
      category: "predicted to be an alkaline-earth metal",
      color: null,
      density: 7,
      discovered_by: "GSI Helmholtz Centre for Heavy Ion Research",
      melt: 680,
      ...
      spectral_img: null,
      summary: "Unbinilium, also known as eka-radium or simply element 120, is the hypothetical chemical element in the periodic table with symbol Ubn and atomic number 120. Unbinilium has not yet been synthesized, despite multiple attempts from German and Russian teams. Unbinilium and Ubn are the temporary systematic IUPAC name and symbol, which are used until the element is discovered, confirmed, and a permanent name is decided upon. Unbinilium is expected to be less reactive than Barium and Radium and be closer in behavior to Strontium.",
      symbol: "Ubn",
      xpos: 2,
      ypos: 8,
      shells: [2, 8, 18, 32, 32, 18, 8, 2],
      electron_configuration: "1s2 2s2 2p6 3s2 3p6 3d10 4s2 4p6 4d10 4f14 5s2 5p6 5d10 5f14 6s2 6p6 6d10 7s2 7p6 8s2",
      electron_affinity: null,
      electronegativity_pauling: null,
      ionization_energies: []
    }
...
var elementTypes = [
    {
        name: "Alkali Metals",
        props: [
            "The Alkali metals consists of Group 1 elements, which lies in the s-block of the periodic table.",
            "Includes: Lithium (Li), Sodium (Na), Potassium (K), Rubidium (Rb), Caesium (Cs), Francium (Fr), Ununennium (Uue).",
            ...
            "All of the discovered alkali metals occur in nature as their compounds: in order of abundance, sodium is the most abundant, followed by potassium, lithium, rubidium, caesium, and finally francium, which is very rare due to its extremely high radioactivity.",
            "They are highly reactive, hence must be stored under oil to prevent reaction with air, and are found naturally only in salts and never as the free elements. Caesium, the fifth alkali metal, is the most reactive of all the metals."
        ]
    },
    {
        name: "Alkaline Earth Metals",
        props: [
            "The Alkaline Earth metals consists of Group 2 elements, which lies in the s-block of the periodic table.",
            "Includes: Beryllium (Be), Magnesium (Mg), Calcium (Ca), Strontium (Sr), Barium (Ba), Radium (Ra), Unbinilium (Ubn).",
            "The elements have very similar properties: they are all shiny, silvery-white, soft, and have relatively low densities, melting points, and boiling points. They are somewhat reactive metals at standard temperature and pressure.",
            ...
            "They all react with the halogens to form the alkaline earth metal halides, all of which are ionic crystalline compounds (except for beryllium chloride, which is covalent)."
        ]
    },
    {
        ...
        props: [
            ...
            "Transition metals have several general properties. They are harder and less reactive than the alkaline earth metals. They are also harder than the post-transition metals. They make colorful chemical compounds with other elements.",
            "They are both ductile and malleable, and good conductor of heat and electricity.",
            ...
            "Some of the transition metals are necessary to keep humans healthy, such as iron, zinc, and chromium. Other elements in the transition metals can be harmful to our body, like cadmium and mercury. Other elements like gold or silver do not harm us."
        ]
    },
    {
      ...
      props: [
          ...
          "Includes: Aluminium (Al), Gallium (Ga), Indium (In), Tin (Sn), Thallium (Tl), Lead (Pb), Bismuth (Bi). The elements Nihonium (Nh), Flerovium (Fl), Moscovium (Mc), and Livermorium (Lv), are also considered to possibly belong to the post-transition metal family.",
          "Physically, post-transition metals are soft (or brittle), have poor mechanical strength, and have melting and boiling points lower than those of the transition metals.",
          "Aluminium is the most abundant post-transition metal, and the third most abundant element on earth."
      ]
    },
    {
      name: "Other Non-Metals",
      props: [
          ...
          "Includes: Hydrogen (H), Carbon (C), Nitrogen (N), Oxygen (O), Phosphorus (P), Sulfur (S), Selenium (Se), Halogens and Noble gases. Metalloids can also be considered as non-metals.",
          "Nonmetals show more variability in their properties than metals do. Physically, they largely exist as diatomic or monatomic gases, with the remainder having more substantial (open-packed) forms.",
          "Chemically the nonmetals mostly have high ionisation energies, high electron affinities (Nitrogen and the Noble gases have negative electron affinities) and high electronegativity values.",
          "They generally form ionic or covalent compounds when combined with metals (unlike metals, which mostly form alloys with other metals).",
          "Two of the nonmetals—hydrogen and helium—make up over 99 percent of the observable universe. Another nonmetal, oxygen, makes up almost half of the Earth's crust, oceans, and atmosphere. Living organisms are composed almost entirely of nonmetals: hydrogen, oxygen, carbon, and nitrogen. Nonmetals form many more compounds than metals."
      ]
    },
    {
      name: "Metalloids",
      props: [
          "A metalloid is an element having characteristics in between that of metals and non-metals. ",
          "Includes: Boron (B), Silicon (Si), Germanium (Ge), Arsenic (As), Antimony (Sb), Tellurium (Te), Polonium (Po). Carbon (C), Aluminum (Al), Selenium (Se) and Astatine (At) are also sometimes (rarely) considered as metalloids.",
          "Metalloids have a shiny appearance like metals but are brittle like non-metals. Their thermal and electrical conductivities fall between metals and non-metals.",
          "Due to their intermediate electronic structures, metalloids have enough empty orbitals into which electrons can move, allowing for conduction of electric current. However, this phenomenon happens only when the metalloid is heated or when small amounts of certain elements are introduced in their crystal lattices (called doping). These specially treated metalloids are called semiconductors.",
          "Silicon is the second most abundant element found in the Earth’s crust."
      ]
    },
    {
      name: "Halogens",
      props: [
          "The halogens are the non-metal elements of Group 17 in the periodic table.",
          "Includes: Fluorine (F), Chlorine (Cl), Bromine (Br), Iodine (I), and Astatine (At). The artificially created element, Tennessine (Ts), may also be a halogen.",
          ...
          "All of the halogens have been observed to react with hydrogen to form hydrogen halides. For fluorine, chlorine, and bromine, this reaction is in the form of: H<sub>2</sub> + X<sub>2</sub> → 2HX",
    ...
    },
    {
      name: "Noble Gases",
      props: [
          "The noble gases are the chemical elements in group 18 of the periodic table. The noble gases were previously referred to as inert gases, but this term is not strictly accurate because several of them do take part in chemical reactions.",
          "Includes: Helium (He), Neon (Ne), Argon (Ar), Krypton (Kr), Xenon (Xe), and the radioactive Radon (Rn). Oganesson (Og) is variously predicted to be a noble gas.",
          ...
          "They are colorless, odorless, tasteless, and nonflammable under standard conditions.",
          "They have weak interatomic force, and consequently have very low melting and boiling points. They are all monatomic gases under standard conditions."
      ]
    },
    {
      name: "Lanthanides",
      props: [
          "The lanthanide series contains elements with atomic numbers 57 to 71 and is the Group 3 in the periodic table. They belong to the f-block.",
          "Includes: Lanthanum (La), Cerium (Ce), Praseodymium (Pr), Neodymium (Nd), Promethium (Pm), Samarium (Sm), Europium (Eu), Gadolinium (Gd), Terbium (Tb), Dysprosium (Dy), Holmium (Ho), Erbium (Er), Thulium (Tm), Ytterbium (Yb), Lutetium (Lu).",
          "These elements were first classified as ‘rare earth’ due to the fact that obtained by reasonably rare minerals. However, this is can be misleading since the Lanthanide elements have a practically unlimited abundance. The term Lanthanides was adopted, originating from the first element of the series, Lanthanum.",
          "The metals have a silvery shine when freshly cut. However, they can tarnish quickly in air, especially Ce, La and Eu. These elements react with water slowly in cold, though that reaction can happen quickly when heated. This is due to their electropositive nature.",
    ...
    },
    {
      name: "Actinides",
      props: [
          "The Actinide series contains elements with atomic numbers 89 to 103 and is the Group 3 in the periodic table. They belong to the f-block.",
          "Includes: Actinium (Ac), Thorium (Th), Protactinium (Pa), Uranium (U), Neptunium (Np), Plutonium (Pu), Americium (Am), Curium (Cm), Berkelium (Bk), Californium (Cf), Einsteinium (Es), Fermium (Fm), Mendelevium (Md), Nobelium (No), Lawrencium (Lr).",
          "They have a silvery or silvery-white luster in metallic form.",
...
var elementTypesWrapper = document.querySelector('#element-types-wrapper');
var elementDetailsContainer = document.querySelector('#element-details-container');
var elementDetailsTitle = document.querySelector('#element-details-title');
var elementDetailsClose = document.querySelector('#element-details-close');
var elementDetailsWrapper = document.querySelector('#element-details-wrapper');

function makePeriodicTable() {
    for (var i = 0; i < elements.length; i++) {
        var element = `<div class="element" id="${elements[i].symbol}" name="${elements[i].category}" data-pos="${i}">
        ...
        periodicTable.innerHTML += element;
    }
}

document.addEventListener('DOMContentLoaded', makePeriodicTable);

periodicTable.addEventListener('click', (e) => {
    openElementDetails(e);
});

elementTypesWrapper.addEventListener('click', (e) => {
    openElementTypeDetails(e);
});

function openElementDetails(e) {
    if (e.target.className === "element" || e.target.parentElement.className === "element") {
        var index = e.target.getAttribute('data-pos') || e.target.parentElement.getAttribute('data-pos'); 
        console.log('Clicked data-pos: ' + index);
        if (index != '57-71' && index != '89-103') {
            elementDetailsContainer.classList.add('showIframe');
            var elDetails = elements[index];
            var elHTML = `<div class="element-details">
                <div class="element-block" id="${elDetails.symbol}" name="${elDetails.name}" data-pos="${elDetails.number-1}">
                    <div id="el-details-number" class="number">${elDetails.number}</div>
                    <div id="el-details-symbol" class="symbol">${elDetails.symbol}</div>
                    <div id="el-details-name" class="name">${elDetails.name}</div>
                    <div id="el-details-atomic-mass" class="atomic-mass">${elDetails.atomic_mass}</div>
                </div>

                <div>${elDetails.summary}</div>

                <table>
                  <tr>
                    <td class="key">Discovered by</td>
                    <td class="value"> : ${elDetails.discovered_by || 'unknown'}</td>
                  </tr>
                  <tr>
                    <td class="key">Appearance</td>
                    <td class="value"> : ${elDetails.appearance || 'unknown'}</td>
                  </tr>
                  <tr>
                    <td class="key">Boiling Point</td>
                    <td class="value"> : ${elDetails.boil || 'unknown'} &deg;C</td>
                  </tr>
                  <tr>
                    <td class="key">Melting Point</td>
                    <td class="value"> : ${elDetails.melt || 'unknown'} &deg;C</td>
                  </tr>
                  <tr>
                    <td class="key">Density</td>
                    <td class="value"> : ${elDetails.density || 'unknown'} g/cm<sup>3</sup></td>
                  </tr>
                  <tr>
                    <td class="key">Atomic weight</td>
                    <td class="value"> : ${elDetails.atomic_mass}</td>
                  </tr>
                  <tr>
                    <td class="key">Natural Phase</td>
                    <td class="value"> : ${elDetails.phase || 'unknown'}</td>
                  </tr>
                  <tr>
                    <td class="key">Shells</td>
                    <td class="value"> : [${elDetails.shells.join(', ') || 'unknown'}]</td>
                  </tr>
                </table>
            </div>`;

            elementDetailsWrapper.innerHTML = elHTML;
            elementDetailsTitle.innerHTML = elDetails.name;
        }
    }
}

function openElementTypeDetails(e) {
    console.log('Element type clicked');
    if (e.target.className === "element-type" || e.target.parentElement.className === "element-type") {
        var index = e.target.getAttribute('data-pos') || e.target.parentElement.getAttribute('data-pos'); 
        console.log('Clicked element-type data-pos: ' + index);
        if (index >= 0 && index < elementTypes.length) {
            elementDetailsContainer.classList.add('showIframe');
            var details = elementTypes[index];
            var props = details.props;
            var html = `<div class="element-details"><ul class="element-type-props">`;
            props.forEach(function(prop) {
                html = html + (`<li>` + prop + `</li>`);
            });
            html = html + `</ul></div>`;

            elementDetailsWrapper.innerHTML = html;
            elementDetailsTitle.innerHTML = details.name;
        }
    }
}

elementDetailsClose.addEventListener('click', (e) => {
    elementDetailsContainer.classList.remove('showIframe');
})
